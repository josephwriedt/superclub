...
var $author$project$Main$ATT = {$: 'ATT'};
var $author$project$Main$Both = {$: 'Both'};
var $author$project$Main$DEF = {$: 'DEF'};
var $elm$core$Basics$False = {$: 'False'};
var $author$project$Main$GK = {$: 'GK'};
var $author$project$Main$Left = {$: 'Left'};
var $author$project$Main$None = {$: 'None'};
var $author$project$Main$Player = F7(
	function (name, position, chemistry, ability, potential, market_value, scout_value) {
		return {ability: ability, chemistry: chemistry, market_value: market_value, name: name, position: position, potential: potential, scout_value: scout_value};
	});
...
var $author$project$Main$hasChemistry = F2(
	function (a, b) {
		var _v0 = _Utils_Tuple2(a.chemistry, b.chemistry);
		_v0$4:
		while (true) {
			switch (_v0.a.$) {
				case 'Right':
...
var $author$project$Example$hasChemistry = function () {
	var right = A7($author$project$Main$Player, '', $author$project$Main$DEF, $author$project$Main$Right, 0, 0, 0, 0);
	var none = A7($author$project$Main$Player, '', $author$project$Main$ATT, $author$project$Main$None, 0, 0, 0, 0);
	var left = A7($author$project$Main$Player, '', $author$project$Main$GK, $author$project$Main$Left, 0, 0, 0, 0);
	var both = A7($author$project$Main$Player, '', $author$project$Main$ATT, $author$project$Main$Both, 0, 0, 0, 0);
	return A2(
			...
			[
				...
				function (_v0) {
					return A2(
						...
						false,
						A2($author$project$Main$hasChemistry, none, none));
				}),
				A2(
				$elm_explorations$test$Test$test,
				'Opposite Chemistry',
				function (_v1) {
					return A2(
						$elm_explorations$test$Expect$equal,
						false,
						A2($author$project$Main$hasChemistry, left, right));
				}),
				A2(
				$elm_explorations$test$Test$test,
				'Right with Left',
				function (_v2) {
					return A2(
						$elm_explorations$test$Expect$equal,
						true,
						A2($author$project$Main$hasChemistry, right, left));
				}),
				A2(
				$elm_explorations$test$Test$test,
				'Right with Both',
				function (_v3) {
					return A2(
						$elm_explorations$test$Expect$equal,
						true,
						A2($author$project$Main$hasChemistry, right, both));
				}),
				A2(
				$elm_explorations$test$Test$test,
				'Both with Left',
				function (_v4) {
					return A2(
						$elm_explorations$test$Expect$equal,
						true,
						A2($author$project$Main$hasChemistry, both, left));
				}),
				A2(
				$elm_explorations$test$Test$test,
				'Both with Both',
				function (_v5) {
					return A2(
						$elm_explorations$test$Expect$equal,
						true,
						A2($author$project$Main$hasChemistry, both, both));
				})
			]));
}();
...
var $author$project$Main$simGame = F2(
	function (a, b) {
		var sum = A3($elm$core$Basics$clamp, 2, 12, a + b);
		return (sum <= 6) ? $author$project$Main$Loss : ((sum <= 8) ? $author$project$Main$Draw : $author$project$Main$Win);
	});
var $author$project$Example$simGame = A2(
	$elm_explorations$test$Test$describe,
	'Simulate Game',
	_List_fromArray(
		[
			...
			function (_v0) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$author$project$Main$Loss,
					A2($author$project$Main$simGame, 1, 1));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'Winning Rolls',
			function (_v1) {
				return A2(
					...
					A2($author$project$Main$simGame, 4, 5));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'Tie Rolls',
			function (_v2) {
				return A2(
					...
					A2($author$project$Main$simGame, 3, 4));
			})
		]));
var $author$project$Test$Generated$Main$main = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$author$project$Test$Runner$Node$check($author$project$Example$simGame),
					$author$project$Test$Runner$Node$check($author$project$Example$hasChemistry)
				]))
		]));
_Platform_export({'Test':{'Generated':{'Main':{'init':$author$project$Test$Generated$Main$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-5597.sock";
var net = require('net'),
