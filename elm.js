...
var $author$project$Club$NewlyPromoted = {$: 'NewlyPromoted'};
...
var $author$project$Init$arsenalReserves = _List_fromArray(
	[
		...
		$author$project$Player$Player(
		{ability: 2, chemistry: $author$project$Player$NoChemistry, market_value: 15, name: 'Turner', position: $author$project$Player$GK, potential: 2, scout_value: 10}),
		$author$project$Player$Player(
		{ability: 2, chemistry: $author$project$Player$NoChemistry, market_value: 10, name: 'Cedric', position: $author$project$Player$DEF, potential: 3, scout_value: 5}),
		$author$project$Player$Player(
		...
		$author$project$Player$PlayerPlaceholder('10'),
		$author$project$Player$PlayerPlaceholder('11'),
		$author$project$Player$PlayerPlaceholder('12'),
		$author$project$Player$PlayerPlaceholder('13'),
		$author$project$Player$PlayerPlaceholder('14'),
		$author$project$Player$PlayerPlaceholder('15')
	]);
var $author$project$Player$Right = {$: 'Right'};
var $author$project$Player$playerPlaceHolderName = F2(
	function (positionName, id) {
		return $author$project$Player$PlayerPlaceholder(
			A2(
				$elm$core$String$join,
				'-',
				_List_fromArray(
...
var $author$project$Init$arsenalAttackers = _List_fromArray(
	[
		$author$project$Player$Player(
		{ability: 4, chemistry: $author$project$Player$NoChemistry, market_value: 60, name: 'Jesus', position: $author$project$Player$ATT, potential: 5, scout_value: 40}),
		$author$project$Player$Player(
		{ability: 3, chemistry: $author$project$Player$Right, market_value: 40, name: 'Martinelli', position: $author$project$Player$ATT, potential: 5, scout_value: 20}),
		$author$project$Player$Player(
		{ability: 3, chemistry: $author$project$Player$Left, market_value: 25, name: 'Saka', position: $author$project$Player$ATT, potential: 6, scout_value: 12}),
		A2($author$project$Player$playerPlaceHolderName, 'starter-attacker', 1),
		A2($author$project$Player$playerPlaceHolderName, 'starter-attacker', 2)
	]);
var $author$project$Init$arsenalDefenders = _List_fromArray(
	[
		$author$project$Player$Player(
		{ability: 3, chemistry: $author$project$Player$NoChemistry, market_value: 30, name: 'Ramsdale', position: $author$project$Player$GK, potential: 5, scout_value: 15}),
		$author$project$Player$Player(
		{ability: 3, chemistry: $author$project$Player$Right, market_value: 30, name: 'Tierney', position: $author$project$Player$DEF, potential: 4, scout_value: 15}),
		$author$project$Player$Player(
		{ability: 3, chemistry: $author$project$Player$NoChemistry, market_value: 45, name: 'Saliba', position: $author$project$Player$DEF, potential: 6, scout_value: 27}),
		$author$project$Player$Player(
		{ability: 3, chemistry: $author$project$Player$Right, market_value: 10, name: 'White', position: $author$project$Player$DEF, potential: 4, scout_value: 5}),
		$author$project$Player$Player(
...
var $author$project$Init$arsenalMidfielders = _List_fromArray(
	[
		$author$project$Player$Player(
		{ability: 3, chemistry: $author$project$Player$NoChemistry, market_value: 30, name: 'Odegaard', position: $author$project$Player$MID, potential: 6, scout_value: 5}),
		$author$project$Player$Player(
		{ability: 3, chemistry: $author$project$Player$Right, market_value: 20, name: 'Xhaka', position: $author$project$Player$MID, potential: 3, scout_value: 10}),
		$author$project$Player$Player(
		{ability: 5, chemistry: $author$project$Player$NoChemistry, market_value: 35, name: 'Thomas', position: $author$project$Player$MID, potential: 5, scout_value: 24}),
		A2($author$project$Player$playerPlaceHolderName, 'stater-midfielder', 1),
		A2($author$project$Player$playerPlaceHolderName, 'stater-midfielder', 2)
	]);
var $author$project$Init$arsenalStarters = _Utils_ap(
	$author$project$Init$arsenalAttackers,
	_Utils_ap($author$project$Init$arsenalMidfielders, $author$project$Init$arsenalDefenders));
...
var $author$project$Init$playerDeck = _List_fromArray(
	[
		$author$project$Player$Player(
		{ability: 4, chemistry: $author$project$Player$NoChemistry, market_value: 60, name: 'Jesus', position: $author$project$Player$ATT, potential: 5, scout_value: 40}),
		$author$project$Player$Player(
...
var $author$project$Model$init = function (_v0) {
	var starters = $elm$core$Array$fromList($author$project$Init$arsenalStarters);
	var reserves = $elm$core$Array$fromList($author$project$Init$arsenalReserves);
...
var $author$project$Player$playerEquality = F2(
	function (a, b) {
		return _Utils_eq(
			$author$project$Player$playerId(a),
			$author$project$Player$playerId(b));
	});
...
var $author$project$Club$findPlayerInArray = F2(
	function (player, playerArray) {
		var playerComparison = F2(
			function (controlPlayer, _v4) {
				var index = _v4.a;
				var indexPlayer = _v4.b;
				return A2($author$project$Player$playerEquality, controlPlayer, indexPlayer) ? index : (-1);
			});
		var f = F2(
			function (controlPlayer, _v3) {
				var testPlayer = _v3.b;
				return A2($author$project$Player$playerEquality, controlPlayer, testPlayer);
			});
		var filteredList = A2(
			$elm$core$List$filter,
			f(player),
			$elm$core$Array$toIndexedList(playerArray));
		var _v0 = $elm$core$List$length(filteredList);
		if (!_v0) {
			return $elm$core$Maybe$Nothing;
		} else {
			var _v1 = $elm$core$List$head(filteredList);
			if (_v1.$ === 'Just') {
				var _v2 = _v1.a;
				var index = _v2.a;
...
var $author$project$Club$swapPlayersInClub = F3(
	function (club, playerA, playerB) {
		var squad = A2($elm$core$Array$append, club.starters, club.reserves);
		var len = $elm$core$Array$length(club.starters);
		var indexB = A2($author$project$Club$findPlayerInArray, playerB, squad);
		var indexA = A2($author$project$Club$findPlayerInArray, playerA, squad);
		var swappedArray = function () {
			var _v0 = _Utils_Tuple2(indexA, indexB);
			if ((_v0.a.$ === 'Just') && (_v0.b.$ === 'Just')) {
				...
				return A3(
					...
					b,
					playerA,
					A3($elm$core$Array$set, a, playerB, squad));
			} else {
				return squad;
			}
		}();
...
var $author$project$Model$modelSwapPlayers = F2(
	function (model, playerB) {
		var _v0 = model.beingDragged;
		if (_v0.$ === 'Nothing') {
			return model;
		} else {
			var playerA = _v0.a;
			return _Utils_update(
				model,
				{
					...
					club: A3($author$project$Club$swapPlayersInClub, model.club, playerA, playerB)
				});
		}
	});
		...
		switch (msg.$) {
			...
			case 'RandomDeckPlayer':
				return _Utils_Tuple2(
					...
					A2(
						$elm$random$Random$generate,
						$author$project$Msg$RandomPlayer,
						$elm_community$random_extra$Random$List$choose(model.playerDeck)));
			case 'RandomPlayer':
				var _v1 = msg.a;
				var maybePlayer = _v1.a;
				var playerList = _v1.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 'Drag':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							beingDragged: $elm$core$Maybe$Just(player)
						}),
					$elm$core$Platform$Cmd$none);
			case 'DragEnd':
				return _Utils_Tuple2(
			...
			default:
				var player = msg.a;
				return _Utils_Tuple2(
					A2($author$project$Model$modelSwapPlayers, model, player),
					$elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$Gamestyle$borderStyle = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
...
var $author$project$Gamestyle$cardBorderRadiusStyle = $rtfeldman$elm_css$Css$borderRadius(
	$rtfeldman$elm_css$Css$px(10));
var $rtfeldman$elm_css$Css$outlineStyle = $rtfeldman$elm_css$Css$prop1('outline-style');
var $rtfeldman$elm_css$Css$solid = {borderStyle: $rtfeldman$elm_css$Css$Structure$Compatible, textDecorationStyle: $rtfeldman$elm_css$Css$Structure$Compatible, value: 'solid'};
var $author$project$Gamestyle$cardOutlineStyle = $rtfeldman$elm_css$Css$outlineStyle($rtfeldman$elm_css$Css$solid);
var $rtfeldman$elm_css$Css$margin = $rtfeldman$elm_css$Css$prop1('margin');
var $author$project$Gamestyle$marginStyle = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			$rtfeldman$elm_css$Css$margin(
			$rtfeldman$elm_css$Css$px(20))
		]));
var $author$project$Gamestyle$folderStyle = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[$author$project$Gamestyle$borderStyle, $author$project$Gamestyle$cardOutlineStyle, $author$project$Gamestyle$cardBorderRadiusStyle, $author$project$Gamestyle$marginStyle]));
...
var $author$project$Gamestyle$centerText = $rtfeldman$elm_css$Css$textAlign($rtfeldman$elm_css$Css$center);
...
var $author$project$Player$Current = {$: 'Current'};
var $author$project$Player$Potential = {$: 'Potential'};
var $author$project$Player$StarPlaceholder = {$: 'StarPlaceholder'};
var $author$project$Player$ability = function (a) {
	if (a.$ === 'PlayerPlaceholder') {
		return 0;
	} else {
		var player = a.a;
...
var $author$project$Gamestyle$filledStar = function () {
	...
	var starString = $elm$core$String$fromChar(
		$elm$core$Char$fromCode(9733));
	return A2(
		...
		_List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$text(starString)
			]));
}();
var $author$project$Gamestyle$unfilledStar = function () {
	var styles = _List_fromArray(
		[
			$rtfeldman$elm_css$Css$fontSize(
			$rtfeldman$elm_css$Css$pct(100)),
...
var $author$project$Player$generateStar = function (star) {
	switch (star.$) {
		case 'StarPlaceholder':
			return A2($rtfeldman$elm_css$Html$Styled$span, _List_Nil, _List_Nil);
		case 'Current':
			return $author$project$Gamestyle$filledStar;
		default:
			return $author$project$Gamestyle$unfilledStar;
	}
};
var $author$project$Player$generateStarFromMatrix = function (matrix) {
	var generateStarsRow = function (list) {
		return A2(
			$rtfeldman$elm_css$Html$Styled$div,
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Attributes$class('star-row'),
					$rtfeldman$elm_css$Html$Styled$Attributes$css(
					_List_fromArray(
						[$author$project$Gamestyle$centerText]))
				]),
			A2($elm$core$List$map, $author$project$Player$generateStar, list));
	};
	return A2($elm$core$List$map, generateStarsRow, matrix);
};
var $author$project$Player$potential = function (a) {
	if (a.$ === 'PlayerPlaceholder') {
		return 0;
	} else {
		var player = a.a;
...
var $author$project$Player$displayAbility = function (a) {
	var stars = function () {
		var _v0 = _Utils_Tuple2(
			$author$project$Player$ability(a),
			$author$project$Player$potential(a));
		_v0$22:
		while (true) {
			switch (_v0.a) {
				case 1:
					switch (_v0.b) {
						case 1:
							return $author$project$Player$generateStarFromMatrix(
								_List_fromArray(
									[
										_List_fromArray(
										[$author$project$Player$StarPlaceholder, $author$project$Player$Current, $author$project$Player$StarPlaceholder]),
										_List_fromArray(
										[$author$project$Player$StarPlaceholder, $author$project$Player$StarPlaceholder, $author$project$Player$StarPlaceholder])
									]));
						case 2:
							return $author$project$Player$generateStarFromMatrix(
								_List_fromArray(
									[
										_List_fromArray(
										[$author$project$Player$Current, $author$project$Player$StarPlaceholder, $author$project$Player$Potential]),
										_List_fromArray(
										[$author$project$Player$StarPlaceholder, $author$project$Player$StarPlaceholder, $author$project$Player$StarPlaceholder])
									]));
						case 3:
							return $author$project$Player$generateStarFromMatrix(
								_List_fromArray(
									[
										_List_fromArray(
										[$author$project$Player$Current, $author$project$Player$Potential, $author$project$Player$Potential]),
										_List_fromArray(
										[$author$project$Player$StarPlaceholder, $author$project$Player$StarPlaceholder, $author$project$Player$StarPlaceholder])
									]));
						case 4:
							return $author$project$Player$generateStarFromMatrix(
								_List_fromArray(
									[
										...
										[$author$project$Player$Current, $author$project$Player$StarPlaceholder, $author$project$Player$Potential]),
										_List_fromArray(
										[$author$project$Player$Potential, $author$project$Player$StarPlaceholder, $author$project$Player$Potential])
									]));
						case 5:
							return $author$project$Player$generateStarFromMatrix(
								_List_fromArray(
							...
							return $author$project$Player$generateStarFromMatrix(
								_List_fromArray(
									[
										...
										[$author$project$Player$Current, $author$project$Player$Potential, $author$project$Player$Potential]),
										_List_fromArray(
										[$author$project$Player$Potential, $author$project$Player$Potential, $author$project$Player$Potential])
									]));
						default:
							break _v0$22;
					}
						...
						case 2:
							return $author$project$Player$generateStarFromMatrix(
								_List_fromArray(
									[
										_List_fromArray(
										[$author$project$Player$Current, $author$project$Player$StarPlaceholder, $author$project$Player$Current]),
										_List_fromArray(
										[$author$project$Player$StarPlaceholder, $author$project$Player$StarPlaceholder, $author$project$Player$StarPlaceholder])
									]));
						case 3:
							return $author$project$Player$generateStarFromMatrix(
								_List_fromArray(
									[
										_List_fromArray(
										[$author$project$Player$Current, $author$project$Player$Current, $author$project$Player$Potential]),
										_List_fromArray(
										[$author$project$Player$StarPlaceholder, $author$project$Player$StarPlaceholder, $author$project$Player$StarPlaceholder])
									]));
						case 4:
						...
						case 3:
							return $author$project$Player$generateStarFromMatrix(
								_List_fromArray(
									[
										_List_fromArray(
										[$author$project$Player$Current, $author$project$Player$Current, $author$project$Player$Current]),
										_List_fromArray(
										[$author$project$Player$StarPlaceholder, $author$project$Player$StarPlaceholder, $author$project$Player$StarPlaceholder])
									]));
						case 4:
		...
		return _List_fromArray(
			[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text('ERROR with PlayerOrPlaceholder.ability or PlayerOrPlaceholder.potential')
					]))
			]);
	}();
	return A2(
		...
		_List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$Attributes$class('star_content')
			]),
		stars);
};
...
var $author$project$Player$name = function (a) {
	if (a.$ === 'Player') {
		var player = a.a;
		return player.name;
	} else {
...
var $author$project$Gamestyle$cardDimensions = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
...
var $author$project$Gamestyle$paddingStyle = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			$rtfeldman$elm_css$Css$padding(
			$rtfeldman$elm_css$Css$px(10))
		]));
var $author$project$Gamestyle$cardStyle = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[$author$project$Gamestyle$marginStyle, $author$project$Gamestyle$borderStyle, $author$project$Gamestyle$paddingStyle, $author$project$Gamestyle$cardDimensions, $author$project$Gamestyle$cardOutlineStyle, $author$project$Gamestyle$cardBorderRadiusStyle]));
var $author$project$Gamestyle$playerPlaceholderStyle = function (color) {
	return $rtfeldman$elm_css$Css$batch(
		_List_fromArray(
			[
				$author$project$Gamestyle$cardStyle,
...
var $author$project$PlayerDisplay$playerStyle = function (a) {
	var color = function () {
		if (a.$ === 'PlayerPlaceholder') {
			return $rtfeldman$elm_css$Css$hex('#e0e0e0');
		} else {
			var player = a.a;
			var _v1 = player.position;
			switch (_v1.$) {
				case 'GK':
					return A3($rtfeldman$elm_css$Css$rgb, 252, 103, 3);
				case 'DEF':
					return $rtfeldman$elm_css$Css$hex('#e01e26');
				case 'MID':
					return $rtfeldman$elm_css$Css$hex('#fcc800');
				default:
					return $rtfeldman$elm_css$Css$hex('#00913c');
			}
		}
	}();
		...
		var attributes = A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Player$playerId(player)),
					$rtfeldman$elm_css$Html$Styled$Attributes$css(
					A2(
						$elm$core$List$append,
						styles,
		...
		return A3(
			...
			_List_fromArray(
				[
					...
					$author$project$Player$displayAbility(player)
				]));
	});
			...
			[
				...
				_List_fromArray(
					[
						...
						$rtfeldman$elm_css$Css$flexFlow1($rtfeldman$elm_css$Css$noWrap)
					]))
			]),
		A2(
			$elm$core$List$map,
			$author$project$PlayerDisplay$playerToHtmlDefault,
			$elm$core$Array$toList(players)));
};
var $author$project$Club$reservesToHtml = function (club) {
	var reserves2 = A3($elm$core$Array$slice, 10, 15, club.reserves);
	var reserves1 = A3($elm$core$Array$slice, 5, 10, club.reserves);
	var reserves0 = A3($elm$core$Array$slice, 0, 5, club.reserves);
	return A3(
		$rtfeldman$elm_css$Html$Styled$node,
		'reserves',
		_List_Nil,
		_List_fromArray(
			[
				$author$project$Club$reservesSliceToHtmlList(reserves0),
				$author$project$Club$reservesSliceToHtmlList(reserves1),
				$author$project$Club$reservesSliceToHtmlList(reserves2)
			]));
};
var $author$project$Club$clubAttackers = function (club) {
	return A3($elm$core$Array$slice, 0, 5, club.starters);
};
var $author$project$Club$attackersToHtml = function (club) {
	var playersHtml = A2(
		$elm$core$List$map,
		$author$project$PlayerDisplay$playerToHtmlDefault,
		$elm$core$Array$toList(
			$author$project$Club$clubAttackers(club)));
	...
	return A3($rtfeldman$elm_css$Html$Styled$node, 'attack', attributes, playersHtml);
};
var $author$project$Club$clubDefenders = function (club) {
	return A3($elm$core$Array$slice, 11, 15, club.starters);
};
var $author$project$Player$defaultGoalkeeper = $author$project$Player$Player(
	{ability: 1, chemistry: $author$project$Player$NoChemistry, market_value: 0, name: 'Woods', position: $author$project$Player$GK, potential: 1, scout_value: 0});
...
var $author$project$Club$clubGoalkeeper = function (club) {
	var _v0 = A2($elm$core$Array$get, 10, club.starters);
	if (_v0.$ === 'Just') {
		var player = _v0.a;
		return player;
	} else {
		return $author$project$Player$defaultGoalkeeper;
	}
};
var $author$project$Club$defenseToHtml = function (club) {
	var goalkeeperHtml = $author$project$PlayerDisplay$playerToHtmlDefault(
		$author$project$Club$clubGoalkeeper(club));
	var defendersHtml = A2(
		$elm$core$List$map,
		$author$project$PlayerDisplay$playerToHtmlDefault,
		$elm$core$Array$toList(
			$author$project$Club$clubDefenders(club)));
	var playersHtml = A2($elm$core$List$cons, goalkeeperHtml, defendersHtml);
	var attributes = _List_fromArray(
		[
			$rtfeldman$elm_css$Html$Styled$Attributes$css(
			_List_fromArray(
	...
	return A3($rtfeldman$elm_css$Html$Styled$node, 'defense', attributes, playersHtml);
};
var $author$project$Club$clubMidfielders = function (club) {
	return A3($elm$core$Array$slice, 5, 10, club.starters);
};
var $author$project$Club$midfieldersToHtml = function (club) {
	var playersHtml = A2(
		$elm$core$List$map,
		$author$project$PlayerDisplay$playerToHtmlDefault,
		$elm$core$Array$toList(
			$author$project$Club$clubMidfielders(club)));
	var attributes = _List_fromArray(
		[
			$rtfeldman$elm_css$Html$Styled$Attributes$css(
			_List_fromArray(
	...
	return A3($rtfeldman$elm_css$Html$Styled$node, 'midfield', attributes, playersHtml);
};
var $author$project$Club$startersToHtml = function (club) {
	var midfieldersHtml = $author$project$Club$midfieldersToHtml(club);
	var defenseHtml = $author$project$Club$defenseToHtml(club);
	var attackersHtml = $author$project$Club$attackersToHtml(club);
	return A3(
		$rtfeldman$elm_css$Html$Styled$node,
		'starters',
		_List_Nil,
		_List_fromArray(
			[attackersHtml, midfieldersHtml, defenseHtml]));
};
var $author$project$Club$clubFolderHtml = function (club) {
	var startersHtml = A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$Attributes$css(
				_List_fromArray(
					[$author$project$Gamestyle$folderStyle]))
			]),
		_List_fromArray(
			[
				$author$project$Club$startersToHtml(club)
			]));
	var reservesHtml = A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
		...
		_List_fromArray(
			[
				$author$project$Club$reservesToHtml(club)
			]));
	var attributes = _List_Nil;
	return A3(
		$rtfeldman$elm_css$Html$Styled$node,
		'player-folder',
		attributes,
...
var $author$project$View$view = function (model) {
	var randomPlayerHtml = function () {
		var _v0 = model.randomPlayer;
		if (_v0.$ === 'Just') {
			var player = _v0.a;
			return $author$project$PlayerDisplay$playerToHtmlDefault(player);
		} else {
